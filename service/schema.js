...
exports.find = async (payload, dbClient) => {
   ...
   return { schemas: [await client.describeDoc(payload.requestContext.site_db_name, schemaIds[0], dbClient)] };
}
...
exports.provision = async (payload, dbClient) => {
   return client.listCollectionIds(payload.requestContext.site_db_name, dbClient);
}